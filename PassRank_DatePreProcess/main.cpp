...
int main()
{
    ...
    FILE *fpout;
    FILE *fpnode;
    if(fpin=fopen("E:\\OneDrive\\Laboratory\\PassRankPaper\\PassRankDataSet\\phpbb_frequence_count.txt","r"))
        puts("read Open Ready\n");
    else
        puts("Open Failed\n");

    if(fpout=fopen("E:\\OneDrive\\Laboratory\\PassRankPaper\\PassRankDataSet\\phpbb_Edge_demo.csv","w"))
        puts("Edge Open Ready\n");
    else
        puts("Open Failed\n");

    if(fpnode=fopen("E:\\OneDrive\\Laboratory\\PassRankPaper\\PassRankDataSet\\phpbb_node_demo.csv","w"))
